...
1. `cd /users/rrai8/zebrafish_analysis/Automated-Analysis-of-Zebrafish/examples`

2. `sbatch inference_run.sh 72 150 <name of the folder you want to analyze>`

3. `myq` to check status
